...
3. Với UI đã implement, map đúng ảnh route và kiểm các boundary affected trong 320/390/768/1024/1440 theo `frontend/DESIGN.md`: proportions, type, token, spacing, state, overflow, focus. Review read-only không tự yêu cầu browser/build.
