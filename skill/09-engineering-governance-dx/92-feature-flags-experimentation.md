...
**Gate:** Chỉ experiment/A-B test mới bắt buộc hypothesis, statistical power và stop rule. Không áp dụng yêu cầu thống kê đó cho kill switch, entitlement hoặc release-control flag; mọi flag vẫn cần owner, safe default, audit và removal/rollback phù hợp. Không dùng flag để giữ code chưa hoàn thiện vô hạn.
